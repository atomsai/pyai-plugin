...
This public repository contains Cursor and Factory plugins: `.cursor-plugin/plugin.json`, `.factory-plugin/`, `mcp.json`, skills and the PyAI logo. Keep credentials, private service implementation and customer content out of it.
